def call() {
  pipeline {
    ...
    stages {
      ...
      stage('Code Quality') {
        steps {
          //sh 'sonar-scanner -Dsonar.projectKey=${component} -Dsonar.host.url=http://172.31.44.175:9000 -Dsonar.login=admin -Dsonar.password=admin123 -Dsonar.qualitygate.wait=true'
